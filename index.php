...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1 style="text-align:center"> CS460 PA1_2</h1><br>
        ...
        <div class = "container">
            <form id="ageLimitForm" method="post" action="">
                <div class="input-group mb-3">
                    <button class="btn btn-outline-secondary m-2" type="submit" name="submit1" id="button-addon1">View all movies</button>
...
//                    $ageLimit = $_POST["inputAge"];
                    ...
                    echo "<tr><th class='col-md-2'>mpid</th><th class='col-md-2'>boxoffice_collection</th></tr></thead>";
                ...
                //                    $ageLimit = $_POST["inputAge"];
                    ...
                    try {
                        ...
                        // SQL
                        $stmt = $conn->prepare("SELECT DISTINCT name FROM People, Role WHERE role_name = 'Actor' AND Role.pid = People.id ");
                        $stmt->execute();
