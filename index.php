                ...
                elseif(isset($_POST['submit7'])){
                    //                    $ageLimit = $_POST["inputAge"];
                        ...
                        try {
                            ...
                            // SQL
                            $stmt = $conn->prepare(
                                "INSERT INTO `Likes`(`uemail`, `mpid`) VALUES ('$user', $mpid);");
                            $stmt->execute();
                            ...
                            echo "Success! $user liked movie #$mpid";
                            echo "<script>console.log('Input successfully added');</script>";
                        }
                        catch(PDOException $e) {
                            echo " ***** Please ensure you are entering a valid email/mpid *****";
                            ?><div><br><?php
                                echo "Error: " . $e->getMessage() . "\n";
                                echo "<script>console.log('Input was not successfully added');</script>";
                            ?></div><?php
                        }
                        $conn = null;
                    }
